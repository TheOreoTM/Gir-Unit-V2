import { ApplicationCommandOptionType, InteractionType, ApplicationCommandType } from 'discord-api-types/v10';
...
var InteractionOptionResolver = class {
...
__name(InteractionOptionResolver, "InteractionOptionResolver");
...
export { ApplicationCommandLimits, ApplicationCommandOptionLimits, AutoCompleteLimits, ButtonLimits, ChannelLimits, ChannelMentionRegex, ChannelMessageRegex, DiscordHostnameRegex, DiscordInviteLinkRegex, EmbedLimits, EmojiLimits, EmojiRegex, FormattedCustomEmoji, FormattedCustomEmojiWithGroups, GuildLimits, GuildMemberLimits, HttpUrlRegex, InteractionLimits, InteractionOptionResolver, MessageLimits, MessageLinkRegex, ModalLimits, ModerationLimits, ParsedCustomEmoji, ParsedCustomEmojiWithGroups, RoleLimits, RoleMentionRegex, SelectMenuLimits, SnowflakeRegex, TextInputLimits, TokenRegex, TwemojiRegex, UserLimits, UserOrMemberMentionRegex, WebSocketUrlRegex, WebhookRegex };
