...
async function handleRegistryAPICalls() {
  ...
  if (exports.defaultBehaviorWhenNotIdentical === Enums_js.RegisterBehavior.BulkOverwrite) {
...
async function handleAppendOrUpdate(commandStore, { applicationCommands, globalCommands, guildCommands }) {
  ...
  pieces.container.client.emit(Events_js.Events.ApplicationCommandRegistriesRegistered, registries);
}
