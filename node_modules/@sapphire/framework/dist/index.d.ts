import { Piece, Store, StoreRegistry, AliasStore, AliasPiece, AliasPieceJSON, PieceContext } from '@sapphire/pieces';
...
import { Interaction, Client, ClientEvents, Snowflake, Message, AutocompleteInteraction, ChatInputCommandInteraction, ContextMenuCommandInteraction, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, ChatInputApplicationCommandData, UserApplicationCommandData, MessageApplicationCommandData, ApplicationCommandManager, Collection, ApplicationCommand, PermissionsBitField, CommandInteraction, TextBasedChannel, PermissionResolvable, ClientOptions, Events as Events$1, PermissionsString, Guild, PartialDMChannel } from 'discord.js';
...
declare abstract class InteractionHandler<O extends InteractionHandler.Options = InteractionHandler.Options> extends Piece<O> {
     ...
     */
    readonly interactionHandlerType: InteractionHandlerTypes;
    constructor(context: Piece.Context, options: InteractionHandlerOptions);
...
declare class Command<PreParseReturn = Args, O extends Command.Options = Command.Options> extends AliasPiece<O> {
     ...
     */
    constructor(context: AliasPiece.Context, options?: O);
    /**
...
declare const Events: {
    ...
    readonly GuildMemberAvailable: Events$1.GuildMemberAdd;
...
declare namespace index {
  export {
    index_resolveBoolean as resolveBoolean,
    index_resolveChannel as resolveChannel,
    index_resolveDMChannel as resolveDMChannel,
    index_resolveDate as resolveDate,
    index_resolveEmoji as resolveEmoji,
    index_resolveEnum as resolveEnum,
    index_resolveFloat as resolveFloat,
    index_resolveGuildCategoryChannel as resolveGuildCategoryChannel,
    index_resolveGuildChannel as resolveGuildChannel,
    index_resolveGuildNewsChannel as resolveGuildNewsChannel,
    index_resolveGuildNewsThreadChannel as resolveGuildNewsThreadChannel,
    index_resolveGuildPrivateThreadChannel as resolveGuildPrivateThreadChannel,
    index_resolveGuildPublicThreadChannel as resolveGuildPublicThreadChannel,
    index_resolveGuildStageVoiceChannel as resolveGuildStageVoiceChannel,
    index_resolveGuildTextChannel as resolveGuildTextChannel,
    index_resolveGuildThreadChannel as resolveGuildThreadChannel,
    index_resolveGuildVoiceChannel as resolveGuildVoiceChannel,
    index_resolveHyperlink as resolveHyperlink,
    index_resolveInteger as resolveInteger,
    index_resolveMember as resolveMember,
    index_resolveMessage as resolveMessage,
    index_resolveNumber as resolveNumber,
    index_resolvePartialDMChannel as resolvePartialDMChannel,
    index_resolveRole as resolveRole,
    index_resolveString as resolveString,
    index_resolveUser as resolveUser,
  };
}
...
declare const CorePreconditions: {
    ClientPermissions: typeof CorePrecondition$c;
    Cooldown: typeof CorePrecondition$d;
    DMOnly: typeof CorePrecondition$b;
    Enabled: typeof CorePrecondition$a;
    GuildNewsOnly: typeof CorePrecondition$9;
    GuildNewsThreadOnly: typeof CorePrecondition$8;
    GuildOnly: typeof CorePrecondition$7;
    GuildPrivateThreadOnly: typeof CorePrecondition$6;
    GuildPublicThreadOnly: typeof CorePrecondition$5;
    GuildTextOnly: typeof CorePrecondition$4;
    GuildVoiceOnly: typeof CorePrecondition$2;
    GuildThreadOnly: typeof CorePrecondition$3;
...
export { AllFlowsPrecondition, ApplicationCommandRegistries, ApplicationCommandRegistry, ApplicationCommandRegistryRegisterOptions, ArgOptions, ArgType, Args, ArgsJson, ArgsNextCallback, Argument, ArgumentContext, ArgumentError, ArgumentOptions, ArgumentResult, ArgumentStore, ArrayResultType, AsyncArgumentResult, AsyncPluginHooks, AsyncPreconditionContainerReturn, AsyncPreconditionResult, AutocompleteCommand, AutocompleteCommandContext, AutocompleteInteractionPayload, AwaitableArgumentResult, BooleanArgumentContext, BucketScope, ChatInputCommand, ChatInputCommandAcceptedPayload, ChatInputCommandContext, ChatInputCommandDeniedPayload, ChatInputCommandErrorPayload, ChatInputCommandFinishPayload, ChatInputCommandRunPayload, ChatInputCommandSuccessPayload, ClientLoggerOptions, ClientPermissionsPrecondition, Command, CommandDoesNotHaveChatInputCommandHandlerPayload, CommandDoesNotHaveContextMenuCommandHandlerPayload, CommandDoesNotHaveMessageCommandHandler, CommandJSON, CommandOptions, CommandOptionsRunType, CommandOptionsRunTypeEnum, CommandPreConditions, CommandStore, ContextMenuCommand, ContextMenuCommandAcceptedPayload, ContextMenuCommandContext, ContextMenuCommandDeniedPayload, ContextMenuCommandErrorPayload, ContextMenuCommandFinishPayload, ContextMenuCommandRunPayload, ContextMenuCommandSuccessPayload, CooldownLevel, CooldownOptions, CorePreconditions, DetailedDescriptionCommand, DetailedDescriptionCommandObject, EmojiObject, EnumArgumentContext, Events, IArgument, IChatInputCommandPayload, IContextMenuCommandPayload, IInteractionHandlerPayload, ILogger, IMessageCommandPayload, IPieceError, IPreconditionCondition, IPreconditionContainer, Identifiers, InteractionHandler, InteractionHandlerError, InteractionHandlerFilters, InteractionHandlerJSON, InteractionHandlerOptions, InteractionHandlerParseError, InteractionHandlerParseResult, InteractionHandlerStore, InteractionHandlerTypes, InternalRegistryAPIType, Listener, ListenerErrorPayload, ListenerJSON, ListenerOptions, ListenerStore, LogLevel, LogMethods, Logger, MemberArgumentContext, MessageArgumentContext, MessageCommand, MessageCommandAcceptedPayload, MessageCommandContext, MessageCommandDeniedPayload, MessageCommandErrorPayload, MessageCommandFinishPayload, MessageCommandRunPayload, MessageCommandSuccessPayload, MessageCommandTypingErrorPayload, MessageResolverOptions, Plugin, PluginHook, PluginManager, PreChatInputCommandRunPayload, PreContextMenuCommandRunPayload, PreMessageCommandRunPayload, Precondition, PreconditionArrayResolvable, PreconditionArrayResolvableDetails, PreconditionConditionAnd, PreconditionConditionOr, PreconditionContainerArray, PreconditionContainerResult, PreconditionContainerReturn, PreconditionContainerSingle, PreconditionContext, PreconditionEntryResolvable, PreconditionError, PreconditionKeys, PreconditionOptions, PreconditionResult, PreconditionRunCondition, PreconditionRunMode, PreconditionSingleResolvable, PreconditionSingleResolvableDetails, PreconditionStore, Preconditions, RegisterBehavior, RepeatArgOptions, index as Resolvers, ResultType, SapphireClient, SapphireClientOptions, SapphirePluginAsyncHook, SapphirePluginHook, SapphirePluginHookEntry, SapphirePrefix, SapphirePrefixHook, SimplePreconditionKeys, SimplePreconditionSingleResolvableDetails, SyncPluginHooks, UnknownChatInputCommandPayload, UnknownContextMenuCommandPayload, UnknownMessageCommandNamePayload, UnknownMessageCommandPayload, UserError, UserPermissionsPrecondition, postInitialization, postLogin, preGenericsInitialization, preInitialization, preLogin, version };
