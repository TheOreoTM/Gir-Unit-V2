...
var CorePrecondition = class extends Precondition_js.AllFlowsPrecondition {
  messageRun(message) {
    return message.thread?.type === discord_js.ChannelType.GuildPrivateThread ? this.ok() : this.error({
      identifier: Identifiers_js.Identifiers.PreconditionGuildPrivateThreadOnly,
      message: "You can only run this message command in private server thread channels."
    });
  }
  async chatInputRun(interaction) {
    const channel = await this.fetchChannelFromInteraction(interaction);
    return channel.type === discord_js.ChannelType.GuildPrivateThread ? this.ok() : this.error({
      identifier: Identifiers_js.Identifiers.PreconditionGuildPrivateThreadOnly,
...
//# sourceMappingURL=GuildPrivateThreadOnly.js.map