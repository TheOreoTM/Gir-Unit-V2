...
var _CorePrecondition = class extends Precondition_js.AllFlowsPrecondition {
  constructor() {
    super(...arguments);
  ...
  async messageRun(message, _, context) {
    ...
    if (!message.client.id) {
      return this.error({
        identifier: Identifiers_js.Identifiers.PreconditionClientPermissionsNoClient,
  ...
  sharedRun(requiredPermissions, availablePermissions, commandType) {
    if (!availablePermissions) {
      return this.error({
        identifier: Identifiers_js.Identifiers.PreconditionClientPermissionsNoPermissions,
    ...
    return missing.length === 0 ? this.ok() : this.error({
      identifier: Identifiers_js.Identifiers.PreconditionClientPermissions,
