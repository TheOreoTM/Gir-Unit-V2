...
type PaginatedMessageAction = PaginatedMessageActionButton | PaginatedMessageActionLink | PaginatedMessageActionMenu;
/**
 ...
 * ```
 */
interface PaginatedMessageActionButton extends InteractionButtonComponentData {
 ...
 * ```
 */
interface PaginatedMessageActionLink extends LinkButtonComponentData {
}
/**
 ...
 * ```
 */
interface PaginatedMessageActionMenu extends StringSelectMenuComponentData {
    run(context: PaginatedMessageActionContext): Awaitable<unknown>;
}
/**
...
type PaginatedMessageMessageOptionsUnion = Omit<BaseMessageOptions, 'flags'> | WebhookMessageEditOptions;
/**
...
declare class PaginatedMessage {
     ...
     */
    response: APIMessage | Message | AnyInteractableInteraction | null;
    /**
     * The collector used for handling component interactions.
     */
    collector: InteractionCollector<ButtonInteraction | StringSelectMenuInteraction> | null;
    /**
     ...
     * ```
     */
    addPageEmbed(embed: EmbedBuilder | ((embed: EmbedBuilder) => EmbedBuilder)): this;
    /**
     ...
     * ```
     */
    addAsyncPageEmbed(embed: EmbedBuilder | ((builder: EmbedBuilder) => Promise<EmbedBuilder>)): this;
    /**
     ...
     * ```
     */
    addPageEmbeds(embeds: EmbedBuilder[] | ((embed1: EmbedBuilder, embed2: EmbedBuilder, embed3: EmbedBuilder, embed4: EmbedBuilder, embed5: EmbedBuilder, embed6: EmbedBuilder, embed7: EmbedBuilder, embed8: EmbedBuilder, embed9: EmbedBuilder, embed10: EmbedBuilder) => EmbedBuilder[])): this;
    /**
     ...
     * ```
     */
    addAsyncPageEmbeds(embeds: EmbedBuilder[] | ((embed1: EmbedBuilder, embed2: EmbedBuilder, embed3: EmbedBuilder, embed4: EmbedBuilder, embed5: EmbedBuilder, embed6: EmbedBuilder, embed7: EmbedBuilder, embed8: EmbedBuilder, embed9: EmbedBuilder, embed10: EmbedBuilder) => Promise<EmbedBuilder[]>)): this;
    /**
     ...
     */
    protected setUpMessage(messageOrInteraction: Message | AnyInteractableInteraction, targetUser: User): Promise<void>;
    /**
     ...
     */
    protected handleCollect(targetUser: User, channel: Message['channel'], interaction: ButtonInteraction | StringSelectMenuInteraction): Promise<void>;
    /**
     * Handles the `end` event from the collector.
     * @param reason The reason for which the collector was ended.
     */
    protected handleEnd(_: Collection<Snowflake, ButtonInteraction | StringSelectMenuInteraction>, reason: PaginatedMessageStopReasons): Promise<void>;
    /**
...
declare class LazyPaginatedMessage extends PaginatedMessage {
    ...
    addPageBuilder(builder: MessageBuilder | ((builder: MessageBuilder) => MessageBuilder)): this;
    addPageContent(content: string): this;
    addPageEmbed(embed: EmbedBuilder | ((builder: EmbedBuilder) => EmbedBuilder)): this;
    addPageEmbeds(embeds: EmbedBuilder[] | ((embed1: EmbedBuilder, embed2: EmbedBuilder, embed3: EmbedBuilder, embed4: EmbedBuilder, embed5: EmbedBuilder, embed6: EmbedBuilder, embed7: EmbedBuilder, embed8: EmbedBuilder, embed9: EmbedBuilder, embed10: EmbedBuilder) => EmbedBuilder[])): this;
}
...
declare class PaginatedFieldMessageEmbed<T> extends PaginatedMessage {
     ...
     * ```
     */
    setTemplate(template: EmbedData | EmbedBuilder | ((embed: EmbedBuilder) => EmbedBuilder)): this;
    /**
...
declare class PaginatedMessageEmbedFields extends PaginatedMessage {
     ...
     * ```
     */
    setTemplate(template: EmbedBuilder | EmbedData | ((embed: EmbedBuilder) => EmbedBuilder)): this;
    /**
     * Build the pages of the given array.
     *
...
declare function isButtonComponentBuilder(component: ButtonBuilder | StringSelectMenuBuilder): component is ButtonBuilder;
declare function createPartitionedMessageRow(components: (ButtonBuilder | StringSelectMenuBuilder)[]): (JSONEncodable<APIActionRowComponent<APIButtonComponent | APIStringSelectComponent>> | ActionRowData<ButtonComponentData | StringSelectMenuComponentData | ButtonBuilder | StringSelectMenuBuilder> | APIActionRowComponent<APIButtonComponent | APIStringSelectComponent>)[];
/**
