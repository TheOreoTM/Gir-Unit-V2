...
interface ApiChannelsChannelMessagesMessageReactions {
  ...
  (
    emoji: string,
    userId: '@me'
  ): ApiChannelsChannelMessagesMessageReactionsEmojiMe;
  (
    emoji: string,
    userId: string
  ): ApiChannelsChannelMessagesMessageReactionsEmojiUser;
}
...
interface ApiGuilds {
  ...
  <T extends R<ApiGuildsGuild>, S extends R<ApiGuildsGuild[T]>>(
    guildId: string,
    key: T,
    subKey: S
  ): ApiGuildsGuild[T][S];
...
interface ApiGuildsGuildMembers {
  ...
  <T extends R<ApiGuildsGuildMembersMe>>(
    memberId: '@me',
    key: T
  ): ApiGuildsGuildMembersMe[T];

  (memberId: string): ApiGuildsGuildMembersMember;
  <T extends R<ApiGuildsGuildMembersMember>>(
    memberId: string,
    key: T
  ): ApiGuildsGuildMembersMember[T];
}
...
interface ApiGuildsGuildIntegrations {
  ...
  <T extends R<ApiGuildsGuildIntegrationsIntegration>>(
    integrationId: string,
    key: T
  ): ApiGuildsGuildIntegrationsIntegration[T];
}
...
interface ApiUsers {
  ...
  <T extends R<ApiUsersMe>, S extends R<ApiUsersMe[T]>>(
    userId: '@me',
    key: T,
    subKey: S
  ): ApiUsersMe[T][S];
